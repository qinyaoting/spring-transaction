 ...
 */
public class OneForOneStopStrategy extends OneForOneStrategy {


    public OneForOneStopStrategy() {
    ...
    public OneForOneStopStrategy(PartialFunction<Throwable, Directive> decider) {
        super(decider);
    }
