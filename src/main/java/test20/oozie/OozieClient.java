...
public class OozieClient {
     ...
     */
    public OozieClient(String oozieUrl) {                   //02. 父类里初始化
        this.baseUrl = notEmpty(oozieUrl, "oozieUrl");      //03. 判断是否为空
        if (!this.baseUrl.endsWith("/")) {                  //05. 如果结尾不是/,那在结尾加上/
            this.baseUrl += "/";
        }
    }
    ...
    protected abstract class ClientCallable<T> implements Callable<T> {         //10. 实现了Callable的抽象类
        ...
        public ClientCallable(String method, Long protocolVersion, String collection, String resource, Map<String, String> params) {    //两个构造函数
            this.method = method;
        ...
        public T call() throws OozieClientException {
            try {
                URL url = createURL(protocolVersion, collection, resource, params);     //11. XOozieClient 调call 创建好URL
                if (validateCommand(url.toString())) {
                    if (getDebugMode() > 0) {
                        System.out.println(method + " " + url);
                    }
                    return call(createRetryableConnection(url, method));                //12.调子类的方法
                }
                else {
     ...
     * @return the string
     * @throws org.apache.oozie.client.OozieClientException the oozie client exception
     */
     ...
     * @throws org.apache.oozie.client.OozieClientException thrown if some actions could not be killed.
     */
     ...
     * @throws org.apache.oozie.client.OozieClientException thrown if the job could not be changed.
     */
    ...
    */
     ...
     * @throws org.apache.oozie.client.OozieClientException if it fails to set the safe mode status.
     */
     ...
     *
     * @return the Oozie server build version.
     * @throws org.apache.oozie.client.OozieClientException throw if it the server build version could not be retrieved.
     */
     ...
     * @throws org.apache.oozie.client.OozieClientException thrown if the job's status could not be retrieved
     */
     ...
     * @throws org.apache.oozie.client.OozieClientException throw if it the queue dump could not be retrieved.
     */
     ...
     *
     * @return the list of available Oozie servers.
     * @throws org.apache.oozie.client.OozieClientException throw if it the list of available Oozie servers could not be retrieved.
     */
     ...
     *
     * @return the Oozie system configuration.
     * @throws org.apache.oozie.client.OozieClientException throw if the system configuration could not be retrieved.
     */
     ...
     *
     * @return the Oozie Java system properties.
     * @throws org.apache.oozie.client.OozieClientException throw if the system properties could not be retrieved.
     */
     ...
     *
     * @return the Oozie system OS environment.
     * @throws org.apache.oozie.client.OozieClientException throw if the system OS environment could not be retrieved.
     */
     ...
     * @throws org.apache.oozie.client.OozieClientException throw if the metrics could not be retrieved.
     */
     ...
     * @throws org.apache.oozie.client.OozieClientException throw if the intstrumentation could not be retrieved.
     */
    ...
    public static String notEmpty(String str, String name) {
        if (str == null) {
            throw new IllegalArgumentException(name + " cannot be null");       //04. 先判断是否是null,再判断字符串长度 name貌似没有用 抛IllegalArgumentException异常,不用方法后声明
        }
        if (str.length() == 0) {
